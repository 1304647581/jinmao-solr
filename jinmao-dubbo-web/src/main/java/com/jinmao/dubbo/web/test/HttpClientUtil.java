package com.jinmao.dubbo.web.test;
...
public class HttpClientUtil {
	...
	public static void main(String args[]) throws Exception {
		//访问地址
		String url = "http://127.0.0.1:5012/agentfollow/insertAgentFollow";
//		
//		AgentFollow agentFollow = new AgentFollow();
//		agentFollow.setCustomerCode("547b95ad21");
//		agentFollow.setCustomerName("二哈");
//		agentFollow.setFollowType(0);
//		agentFollow.setRemark("2222222");
		
		
		//发送
//		String resultString = HttpClientUtil.httpPost(url, agentFollow.toJson(), "utf-8");
